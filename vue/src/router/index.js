    ...
    { path: "/", redirect: "/login" },
    {
      ...
      children: [
        ...
        { path: "admin", component: () => import("@/views/manager/Admin.vue") },
        {
          ...
          meta: { manageRole: "STUDENT", title: "学生管理" }
        },
        {
          path: "admin-teachers",
          component: () => import("@/views/manager/UserManage.vue"),
          meta: { manageRole: "TEACHER", title: "教师管理" }
        },
        ...
        { path: "teacher-attendance", component: () => import("@/views/teacher/AttendanceManage.vue") },
...
router.beforeEach((to, from, next) => {
  ...
  if (to.path.startsWith("/manager/admin-") && user.role !== "ADMIN") {
    return next("/manager/home");
  }
  next();
});
